...
You need to download the model files first and save them in your folder. Then you can run the scripts below, we recommend that the parameter should be given as an absolute path.
```bash
